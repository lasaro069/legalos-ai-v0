...
export default async function SettingsPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Ajustes del Despacho</h1>
        <p className="text-sm text-slate-500 mt-1">Configuración de mi perfil, mi firma y mi equipo de trabajo.</p>
      </div>
